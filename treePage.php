...
body > div > div.dashboard-wrapper > div.container-fluid.dashboard-content > div:nth-child(2) > div > div > div > div > div > div > div > div.tree{
...
<?=$_SESSION['name']?><span class="badge badge-pill badge-success">verified</span></h5>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="treePage.php" class="breadcrumb-link">Network</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
<div class="container">
    <div class="row" style="margin-top: 50px ;margin-left: 1%;margin-right: 1%; padding: 20px;">
        <div class="col-md-12">
