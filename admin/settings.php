...
function format_var_html($key, $value) {
    ...
    $html .= '<input class"form-control" type="' . $type . '" name="' . $key . '" id="' . $key . '" value="' . $value . '" placeholder="' . format_key($key) . '"' . $checked . '>';
    return $html;
}
if (!empty($_POST)) {
                ...
                <nav class="navbar navbar-expand-lg navbar-light" style="padding: 0;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="emailtemplate.php" >
                                <i class="fas fa-envelope"></i>Email Template</a>
                            </li>
                            <li class="nav-item">
